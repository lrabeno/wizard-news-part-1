const data = [
  ...
  },
  {
    ...
    content:
      "Learning untransfiguration is going to be mandatory at Hogwarts School of Witchcraft and Wizardry from 2017 onwards. Untransfiguration will be covered in beginner-level spellbooks such as A Beginner's Guide to Transfiguration. Failure to at least attempt to untranfigure a wrongly-done transfiguration will be considered irresponsible.",
    name: "Baddock",
  ...
  },
  {
    ...
    content:
      "Some scrolls need conservation treatment before they can be safely transported, handled, and digitized.  After these questions are answered, Preservation and Information Technology Specialists assess the project requirements and create the digitized version.",
    name: "Alphard",
  ...
  },
  {
    id: 9,
    upvotes: 102,
    title: "Conserving water plants cheatsheet.",
    content:
  ...
  },
  {
    ...
    content:
      "Question: Are there any non-jinx incantations available to detect which spell used on a bug?",
    name: "Lupin",
    date: new Date(),
  },
];
